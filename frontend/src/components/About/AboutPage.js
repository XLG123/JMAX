        ...
        <div className='member-box-container'>
          <div className='member-box'>
            ...
            <div className='member-name'>
              <div className='member-name'>
                <span id='change-J'>J</span>ordy</div>
              <br />
              <div className='member-pos'>Backend Lead</div>
              <br />
              <a href={gitHubLinks[0]}>
                <Avatar alt="jor-profile" src={avatar1} sx={{ width: "12vw", height: "12vw" }} className="member-avatar" onMouseEnter={lightUpJMAX}  onMouseLeave={undoLightUp}/>
              </a>
            ...
            <div className='member-name'>
              <div className='member-name'>
                <span id='change-M'>M</span>anel</div>
              <br />
              <div className='member-pos'>Backend Lead</div>
              <br />
              <a href={gitHubLinks[1]}>
                <Avatar alt="mal-profile" src={avatar2} sx={{ width: "12vw", height: "12vw" }} className="member-avatar" onMouseEnter={lightUpJMAX} onMouseLeave={undoLightUp}/>
              </a>
            ...
            <div className='member-name'>
              <div className='member-name'>
                <span id='change-A'>A</span>smaa</div>
              <br />
              <div className='member-pos'>Frontend Lead</div>
              <br />
              <a href={gitHubLinks[2]}>
                <Avatar alt="asm-profile" src={avatar3} sx={{ width: "12vw", height: "12vw" }} className="member-avatar" onMouseEnter={lightUpJMAX} onMouseLeave={undoLightUp}/>
              </a>
            ...
            <div className='member-name'>
              <div className='member-name'>
                <span id='change-X'>X</span>iao Lin</div>
              <br />
              <div className='member-pos'>Frontend Lead</div>
              <br />
              <a href={gitHubLinks[3]}>
                <Avatar alt="xlg-profile" src={avatar4} sx={{ width: "12vw", height: "12vw" }} className="member-avatar" onMouseEnter={lightUpJMAX} onMouseLeave={undoLightUp}/>
              </a>
            </div>
